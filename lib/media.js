...
function run(cmd, args, { onStderrLine, cwd } = {}) {
...
export async function downloadAudio(url, dir, onProgress) {
  ...
  // --print-json emits one JSON object per download on stdout, mixed with
  // [download] progress lines; take the last line that parses as an object.
  let info = null;
